...
%% Decoding in time for Children - Plotting
% -------------------------------------------------------------------
...
%--------------------------------------------------------------------------
%% FAMILIAR data
input_folder  = fullfile(projectRoot, 'results', 'DA_mean', 'Children_100', 'fam');
...
%% NOVEL data
input_folder  = fullfile(projectRoot, 'results', 'DA_mean', 'Children_100', 'novel');
...
%     title('Time course of category decoding in Children');
