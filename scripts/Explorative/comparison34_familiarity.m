...
%% Exploratory Analysis: Comparison of Familiarity between day 3 and day 4 (Infants) - Plotting
% -------------------------------------------------------------------
...
input_folder  = fullfile(projectRoot, 'results', 'DA_mean', 'Infants_100', 'familiarity');
...
%     title('Time course of familiarity decoding in Infants');
...
save(fullfile(res, 'famcomp_infants.mat'), 'res_famcomp');
